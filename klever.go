// Package klever is a micro static router and simply blog enginee
package klever
...
// Config - Get HTTP port file from 'config.json'. This file is generated by Scaffold package
type Config struct {
	AppPort string
}

// Pages - Get URL Route and Template file
type Pages struct {
	Route, Template string
}

// Posts - Render JSON posts
type Posts struct {
	Title, Date, URL string
	Post             template.HTML
}

// Layout - Render templates.
...
// SetPage route the Tempate file
func (p *Pages) SetPage(setRoute, setFile string) {
	p.Route = setRoute
	p.Template = setFile
}

// Page is used to render Route.
// Usage: In the main function use: klever.Page(route, file)
...
// BlogPosts show JSON posts in HTML
